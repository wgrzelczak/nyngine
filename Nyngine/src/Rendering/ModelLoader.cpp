...
namespace ny::Rendering::ModelLoader
{
    ...
    void LoadModel(Model& model, std::string filename)
    {
        ...
        obj.faces =
            {
                {1, 1, 1}, {2, 2, 1}, {3, 3, 1}, {3, 3, 1}, {2, 2, 1}, {4, 4, 1}, {3, 1, 2}, {4, 2, 2}, {5, 3, 2}, {5, 3, 2}, {4, 2, 2}, {6, 4, 2}, {5, 4, 3}, {6, 3, 3}, {7, 2, 3}, {7, 2, 3}, {6, 3, 3}, {8, 1, 3}, {7, 1, 4}, {8, 2, 4}, {1, 3, 4}, {1, 3, 4}, {8, 2, 4}, {2, 4, 4}, {2, 1, 5}, {8, 2, 5}, {4, 3, 5}, {4, 3, 5}, {8, 2, 5}, {6, 4, 5}, {7, 1, 6}, {1, 2, 6}, {5, 3, 6}, {5, 3, 6}, {1, 2, 6}, {3, 4, 6}};
